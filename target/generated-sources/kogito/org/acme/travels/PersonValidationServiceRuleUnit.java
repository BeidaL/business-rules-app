...
public class PersonValidationServiceRuleUnit extends AbstractRuleUnit<PersonValidationService> {
    ...
    public PersonValidationServiceRuleUnit(org.kie.kogito.Application app) {
        super(PersonValidationService.class.getCanonicalName(), app.get(RuleUnits.class));
        this.app = app;
    }

    public org.acme.travels.PersonValidationServiceRuleUnitInstance internalCreateInstance(PersonValidationService value) {
        return new org.acme.travels.PersonValidationServiceRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new org.acme.travels.Rules2E460E98FBDF296CF50748F35F942A65_PersonValidationService(), ruleBaseConfig);
        return kb;
    }
}
